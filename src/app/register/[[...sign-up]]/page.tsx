...
const appearance = {
  ...
  elements: {
    ...
    socialButtonsBlockButton:
      "bg-white border-gray-200 hover:bg-gray-50 hover:border-gray-300 transition-all shadow-sm",
    socialButtonsBlockButtonText: "text-gray-600 font-semibold",
    formButtonPrimary:
      "bg-indigo-600 hover:bg-indigo-700 text-white shadow-md normal-case text-sm",
